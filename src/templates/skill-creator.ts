...
const DESCRIPTION =
	...
	"Use when users want to create a skill from scratch or update an existing skill.";

/** The add-skill helper, adapted from Anthropic's skill-creator (Apache 2.0). */
export function skillCreatorSkill(): Skill {
	return createSkill({
		name: "add-skill",
